...
// etc).
export function getOwnerWindow(node: HTMLElement): Window | null {
...
export function mergeRectOffsets(rects: Rect[]): Rect {
...
export function getElementDimensions(domElement: Element): Dims {
